...
//        public static final String BaseURL = "https://ibhelper.com";
    ...
    public static final String BLOG_CATEGORY = BaseURL + "/blog/category";
    public static final String BLOG_AUTHOR = BaseURL + "/blog/author";
    public static final String HELP = BaseURL + "/help";
    public static final String HELP_SEARCH = BaseURL + "/help/search";
    public static final String HELP_TOPIC = BaseURL + "/help/topic";
    public static final String ESSAY_WRITERS = BaseURL + "/essay-writers";
    public static final String IB_WRITERS = BaseURL + "/ib-writers";
    public static final String HOW_IT_WORKS = BaseURL + "/how-it-works";
    public static final String PRICES_AND_DISCOUNTS = BaseURL + "/prices-and-discounts";
    public static final String SAMPLES = BaseURL + "/samples";
    public static final String CONTACTS = BaseURL + "/contacts";
    public static final String ABOUT = BaseURL + "/about";
    public static final String TESTIMONIALS = BaseURL + "/testimonials";
    public static final String POLICY_PRIVACY = BaseURL + "/legal/privacy";
    public static final String POLICY_REFUND = BaseURL + "/legal/refund";
    public static final String POLICY_COOKIE = BaseURL + "/legal/cookie";
    public static final String POLICY_REVISION = BaseURL + "/legal/revision";
    ...
    public static final String SIGN_IN = BaseURL + "/signin";
    public static final String SIGN_UP = BaseURL + "/signup";
    public static final String SETTINGS = BaseURL + "/settings";
    public static final String OUR_WRITERS = BaseURL + "/our-writers";
    public static final String WRITE_FOR_US = BaseURL + "/write-for-us";
    public static final String FAST_ESSAY_WRITERS = BaseURL + "/fast-essay-writer";
    ...
    public String[] blogPost = {
            "/high-school-career-planning-guide",
            "/revise-rewrite-college-essay-guide",
            "/authentic-discussion-posts-guide",
            "/students-guide-to-marketing-plan-proposal",
            "/introducing-case-studies-in-essays",
            "/research-paper-topics-computer-science",
            "/teaching-modern-essay-evolution",
            "/essay-writing-services-truth-revealed",
            "/athlete-academic-tips",
            "/tok-claims-and-counterclaims-guide",
            "/how-to-get-a-7-in-ib-english",
            "/student-internship-guide",
            "/netflix-shows-essay-writing-inspiration",
            "/ib-extended-essay-guide",
            "/howto-write-conclusion-for-doctoral-thesis",
            "/essay-writing-using-netflix-shows",
            "/afro-american-history-research-paper-topics",
            "/how-to-write-persuasive-essay",
            "/sehs-ia-topic-ideas-football-for-ib-students",
            "/psychology-research-paper-topics",
            "/law-research-paper-topics",
            "/essay-writing-tips-from-experts",
            "/high-school-persuasive-essay-topics",
            "/theology-and-religion-research-topics",
            "/political-science-research-paper-topics",
            "/how-to-write-polite-email-to-professor",
            "/how-to-overcome-language-barriers-in-essay-writing",
            "/maintain-focus-while-writing-essays-with-adhd",
            "/which-rhetorical-devices-use-for-persuasive-essays",
            "/how-to-write-a-business-plan-for-college",
            "/what-is-the-most-difficult-part-of-essay-writing",
            "/how-to-write-original-and-unique-college-essays",
            "/psychology-of-last-minute-essay-writing",
            "/overcoming-dissertation-writers-block",
            "/techniques-to-overcome-stress-and-improve-your-writing",
            "/time-management-tips-for-phd-students",
            "/common-mistakes-in-your-ib-math-ia-paper",
            "/reasons-to-not-drop-out-of-college",
            "/mastering-the-video-essay-for-college-applications",
            "/why-using-ai-for-essays-is-a-bad-idea",
            "/how-to-write-a-concept-paper-for-phd",
            ...
            "/how-to-write-a-cuegis-essay",
            "/how-to-use-figurative-language-for-essays",
            ...
            "/university-persuasive-essay-topics",
